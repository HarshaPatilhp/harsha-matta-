    ...
    <header className="bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 sticky top-0 z-30 shadow-sm backdrop-blur-md bg-white/90">
      <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4">
          <button
            type="button"
            className="md:hidden p-2 -ml-2 text-gray-400 hover:text-gray-500 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500"
        ...
        <div className="flex items-center gap-4 sm:gap-6 ml-auto">
          ...
          <div className="hidden sm:flex flex-col items-end mr-4 border-r border-gray-200 dark:border-slate-700 pr-6">
            <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 tracking-wider">TODAY</span>
          ...
          <div className="flex items-center gap-3 pl-2">
            ...
            <div className="h-9 w-9 rounded-full bg-emerald-100 flex items-center justify-center border-2 border-emerald-500/20 shadow-sm overflow-hidden">
