        ...
        <div class="content">
            ...
            <div class="details">
                ...
                <ul>
                    ...
                    <li><strong>Gotra:</strong> ${booking.gotra || 'Not specified'}</li>
                    <li><strong>Nakshatra:</strong> ${booking.nakshatra || 'Not specified'}</li>
                    <li><strong>Hall Location:</strong> ${booking.hall || 'Not specified'}</li>
